...
/**
 * Servlet implementation class CheckUsernameEmailServlet
 */
@WebServlet("/CheckUsernameEmailServlet")
public class CheckUsernameEmailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckUsernameEmailServlet() {
        super();
